    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="https://phalkun.sgp1.digitaloceanspaces.com/<?php echo e($user->image_url); ?>" target="_blank"><i class="fas fa-eye mx-2"></i></a> <!-- View icon -->
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\maste\Documents\VS code file\VS code file\Year3\Cloud Clone Project\Cloud-Empty\example-app\example-app\resources\views/file.blade.php ENDPATH**/ ?>